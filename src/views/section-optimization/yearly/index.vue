<template>
  <div class="yearlybox">
    ...
    <AddDialog ref="addDialogdom" @addsure="addsure" :zbxlist="zbxlist" :editData="editData" :linelist="linelist" :activetype="activetype"></AddDialog>
  </div>
</template>
<script>
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const data = reactive({
      ...
      treeData: [],
      editData: {},
      currentapiurl: yearlyApi[props.activetype],
    });
    const addsure = (formdata) => {
      ...
      if (formdata.checkDate && formdata.checkDate?.indexOf("T") < 0) {
        formdata.checkDate = formdata.checkDate + "T00:00:00.000Z";
      }
      if (formdata.id) {
        service
          .post({
