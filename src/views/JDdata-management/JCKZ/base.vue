  ...
  <div class="vertivalNetbox">
    <div class="bottombox flexbox">
      <div class="sectionleft">
        <YearLy @getYearly="getYearly" :linelist="linelist" :activetype="activetype" :projectid="$props.planId" :activetab="activetab"></YearLy>
      </div>
      <div class="sectionright">
        <div class="righttopbox flexbox">
          ...
          <div class="yearLyquery flexbox">
            <div>
              <el-date-picker v-model="staterAndEndTime" type="daterange" start-placeholder="开始时间" end-placeholder="结束时间" style="margin-right: 10px; width: 240px" @change="getdata"></el-date-picker>
            </div>
...
import { columData, formItems, apiurls } from './option'
...
export default defineComponent({
  ...
  setup(props) {
      ...
      service
        .get({
          ...
          params: {
            ...
            StartDate: data.staterAndEndTime ? '' : null,
            EndDate: data.staterAndEndTime ? '' : null,
          },
        })
        .then((res) => {
    ...
    return { getdata, actionurl, addsure, ...toRefs(data), pagechange, AddDialogdom, handleclick, handleedit, handledel, search, bachupload, refreshdata }
  },
})
</script>
