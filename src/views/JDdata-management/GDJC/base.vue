...
export default defineComponent({
  ...
  setup(props) {
    ...
    // 获取数据
    const getdata = () => {
      console.log('staterAndEndTime', data.staterAndEndTime)
    ...
    return { getYearly, getdata, actionurl, addsure, ...toRefs(data), pagechange, AddDialogdom, handleclick, handleedit, handledel, search, bachupload, refreshdata }
  },
})
</script>
